  ...
  if (url.includes("whatsapp")) {
    return (
      <div style={{
        ...
        {/* Animated WhatsApp Phone & Hell Desk UI (Despejado) */}
        <div style={{
          position: "relative",
          width: "140px",
          height: "76px",
          ...
          {/* WhatsApp Main Icon (100% libre y visible) */}
          ...
          {/* Floating Urgent Message Bubble 1 (Subido ligeramente para despejar arriba) */}
          <div style={{
            position: "absolute",
            top: "-10px",
            right: "-18px",
          ...
          {/* Floating Message Bubble 2 (Bajado ligeramente para despejar abajo) */}
          <div style={{
            position: "absolute",
            bottom: "-6px",
            left: "-20px",
        ...
        {/* Typing / Bot Active Bar (Bajado un poco más para dejar respirar el ícono) */}
        <div style={{
          display: "flex",
          alignItems: "center",
          gap: "5px",
