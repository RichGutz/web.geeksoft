...
export default function WormHoleCamera() {
  ...
  useEffect(() => {
    // Añadimos niebla profunda para simular la lejanía del agujero de gusano
    // Coincide con el color de fondo #08090d / #020704
    scene.fog = new THREE.FogExp2("#020704", 0.004);
